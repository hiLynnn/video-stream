...
@section("content")
          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="row">             
                <div class="col-md-3">
                  <a href="{{URL::to('admin/sports_category/add_category')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_category')}}"><i class="fa fa-plus"></i> {{trans('words.add_category')}}</a>
                </div>
              </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6" id="card_box_id_{{$category_data->id}}">
                        ...
                        <div class="card m-b-20 p-3 lng_item_grid">
                            <div class="card-body p-0">
                                ...
                                <a href="{{ url('admin/sports_category/edit_category/'.$category_data->id) }}" class="btn waves-effect waves-light btn-success m-b-0 m-r-5" data-toggle="tooltip" title="{{trans('words.edit')}}"> <i class="fa fa-edit"></i> </a>
 ...
 $(".enable_disable").on("change",function(e){      
       ...
       var action_name='sports_cat_status';
 ...
 $(".data_remove").click(function () {  
   ...
   var post_id = $(this).data("id");
   var action_name='sports_cat_delete';
