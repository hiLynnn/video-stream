            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/payment_gateway/cashfree'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Cashfree AppId</label>
                    <div class="col-sm-8">
                      <input type="text" name="cashfree_appid" value="{{ isset($gateway_info->cashfree_appid) ? stripslashes($gateway_info->cashfree_appid) : null }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Cashfree Secret Key</label>
                    <div class="col-sm-8">
                      <input type="text" name="cashfree_secret_key" value="{{ isset($gateway_info->cashfree_secret_key) ? stripslashes($gateway_info->cashfree_secret_key) : null }}" class="form-control">
                    </div>
                  </div>
