            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/payment_gateway/instamojo'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="instamojo_client_id" value="{{ isset($gateway_info->instamojo_client_id) ? stripslashes($gateway_info->instamojo_client_id) : null }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Client Secret</label>
                    <div class="col-sm-8">
                      <input type="text" name="instamojo_client_secret" value="{{ isset($gateway_info->instamojo_client_secret) ? stripslashes($gateway_info->instamojo_client_secret) : null }}" class="form-control">
                    </div>
                  </div>
