            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/payment_gateway/coingate'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.coingate_api_key')}}</label>
                    <div class="col-sm-8">
                      <input type="text" name="coingate_api_key" value="{{ isset($gateway_info->coingate_api_key) ? stripslashes($gateway_info->coingate_api_key) : null }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.coingate_receive_currency')}}</label>
                    <div class="col-sm-8">
                      <input type="text" name="coingate_receive_currency" value="{{ isset($gateway_info->coingate_receive_currency) ? stripslashes($gateway_info->coingate_receive_currency) : null }}" class="form-control">
                    </div>
                  </div>
