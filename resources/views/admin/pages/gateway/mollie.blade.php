            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/payment_gateway/mollie'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="mollie_api_key" value="{{ isset($gateway_info->mollie_api_key) ? stripslashes($gateway_info->mollie_api_key) : null }}" class="form-control">
                    </div>
                  </div>
