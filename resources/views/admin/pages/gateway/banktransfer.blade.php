            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/payment_gateway/banktransfer'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.bank_transfer_info')}}</label>
                    <div class="col-sm-8">
                    <textarea id="elm1" name="banktransfer_info" class="form-control">{{ isset($gateway_info->banktransfer_info) ? stripslashes($gateway_info->banktransfer_info) : null }}</textarea>
