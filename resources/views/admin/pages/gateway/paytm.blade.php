            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/payment_gateway/paytm'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="paytm_merchant_id" value="{{ isset($gateway_info->paytm_merchant_id) ? stripslashes($gateway_info->paytm_merchant_id) : null }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">Merchant Key</label>
                    <div class="col-sm-8">
                      <input type="text" name="paytm_merchant_key" value="{{ isset($gateway_info->paytm_merchant_key) ? stripslashes($gateway_info->paytm_merchant_key) : null }}" class="form-control">
                    </div>
                  </div>
