            ...
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 ...
                 {!! Form::open(array('url' => array('admin/payment_gateway/razorpay'),'class'=>'form-horizontal','name'=>'settings_form','id'=>'settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}  
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="razorpay_key" value="{{ isset($gateway_info->razorpay_key) ? stripslashes($gateway_info->razorpay_key) : null }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.razorpay_key_secret')}}</label>
                    <div class="col-sm-8">
                      <input type="text" name="razorpay_secret" value="{{ isset($gateway_info->razorpay_secret) ? stripslashes($gateway_info->razorpay_secret) : null }}" class="form-control">
                    </div>
                  </div>
