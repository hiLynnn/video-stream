              ...
              <div class="card-box">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="number" name="app_update_version_code" value="{{ isset($settings->app_update_version_code) ? $settings->app_update_version_code : null }}" class="form-control" placeholder="1" min="1" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                    </div>
                  </div>
