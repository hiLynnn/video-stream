              ...
              <div class="row">   
                  <div class="wall-filter-block">  
                    <div class="row" style="align-items: center;justify-content: space-between;">            
                      ...
                      <div class="col-sm-3"> 
                          {!! Form::open(array('url' => 'admin/actor','class'=>'app-search','id'=>'search','role'=>'form','method'=>'get')) !!}   
                      ...
                      <div class="col-sm-4">
                        <div class="checkbox checkbox-success pull-right">
                            ...
                            <a href="{{URL::to('admin/actor/add')}}" class="btn btn-success btn-md waves-effect waves-light pull-right" data-toggle="tooltip" title="{{trans('words.add_actor')}}"><i class="fa fa-plus"></i> {{trans('words.add_actor')}}</a>
                        </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-xs-6" id="card_box_id_{{$data->id}}">
                        ...
                        <div class="card m-b-20">
                            <div class="wall-list-item">
                              ...
                              <img class="card-img-top thumb-xs img-fluid" src="{{URL::to('/'.$data->ad_image)}}" alt="{{ stripslashes($data->ad_name) }}"> 
                              @else
