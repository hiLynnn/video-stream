                   ...
                   @foreach($user_list as $i => $user_data)
                    <tr id="card_box_id_{{$user_data->id}}">
                      ...
                      @if($user_data->google_id!="")
                        - <i class="fa fa-google" data-toggle="tooltip" title="Google Login"></i>
                      @elseif($user_data->facebook_id!="")
                      - <i class="fa fa-facebook" data-toggle="tooltip" title="Facebook Login"></i>
                      @endif
