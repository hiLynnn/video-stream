...
<div style="font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:22px;font-weight:900;line-height:28px;text-align:left;color:#000000">Welcome to {{getcong('site_name')}}</div>
</td>
</tr>
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica, Arial;font-size:16px;line-height:24px;text-align:left;color:#282828">Hi {{$user_data->name}},</div>
</td>
</tr> 
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828">Your subscription on {{getcong('site_name')}} has expired. If you continue watching great videos on our platform, Please renew your subscription.<br/>
        <br/> 
        To login to your account, please click link below...  
</div>

<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:center;color:#282828;margin-top:15px;" align="center">

<a href="{{ \URL::to('login/') }}" style="font-size: 15px;margin-bottom:10px;text-align: center;background: #343565;color: #fff;border-radius: 6px;text-decoration:none;padding:10px 30px;">Login</a>
