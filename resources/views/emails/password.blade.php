...
<a href="{{ $url }}" style="font-size: 15px;margin-bottom:10px;text-align: center;background: #343565;color: #fff;border-radius: 6px;text-decoration:none;padding:10px 30px;">Reset Password</a>
