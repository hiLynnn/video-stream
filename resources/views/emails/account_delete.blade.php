...
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828">As Per Your Request Your Account With {{getcong('site_name')}} is Deleted permanently And We don't have stored any of information shared with us.</div>

<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828"><br/>
Thanks For Your Association with {{getcong('site_name')}}
</div>
</td>
</tr>
</tbody>
