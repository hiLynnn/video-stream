...
<div style="font-family:Helvetica Neue, Helvetica, Arial;font-size:16px;line-height:24px;text-align:left;color:#282828">Hi,</div>
</td>
</tr> 
<tr>
<td dir="ltr" style="font-size:0px;padding:5px 5px 5px 5px;word-break:break-word" align="left">
<div style="font-family:Helvetica Neue, Helvetica;font-size:16px;line-height:24px;text-align:left;color:#282828">Someone recently requested a password change for your account. If this was you, you can set a new password by clicking the link below:
</div>
...
<a href="{{ URL::to('password/reset/'.$token) }}" style="font-size: 15px;margin-bottom:10px;text-align: center;background: #343565;color: #fff;border-radius: 6px;text-decoration:none;padding:10px 30px;">Reset Password</a>
