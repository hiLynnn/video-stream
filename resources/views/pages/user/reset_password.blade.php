      ...
      <div class="col-md-12">
        ...
        <div class="container login-part">
          ...
          <div class="col-12 col-lg-12 col-xl-12 mx-auto">
            <h2 class="form-title-item mb-4">{{trans('words.reset_password')}}</h2>

             
            {!! Form::open(array('url' => 'password/reset','class'=>'vfx_accountform loginform','id'=>'loginform','role'=>'form','onsubmit'=>'return submitForm();')) !!}
            <input type="hidden" name="token" value="{{ $token }}">
                ...
                <div class="form-group">
                  <input type="password" class="form-control" name="password_confirmation" value="" placeholder="{{trans('words.confirm_password')}}" >
                </div>
                @if(getcong('recaptcha_on_forgot_pass'))
                <div class="form-group">
                ...
                @endif                
                <button class="btn-submit btn-block my-4 mb-4 mt-2" type="submit">{{trans('words.submit')}}</button>
            {!! Form::close() !!} 
