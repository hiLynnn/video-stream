 ...
 <script type="text/javascript">
			 FWDEVPUtils.onReady(function(){
				 ...
				 new FWDEVPlayer({		
					 ...
					 stopAtTime:"",
					 videoSource:[
						 {source:"encrypt:{{base64_encode($sports_info->video_url)}}", label:"default"},
						 
						  
						 @if($sports_info->video_quality)
						 @if($sports_info->video_url_480)
						 {source:"encrypt:{{base64_encode($sports_info->video_url_480)}}", label:"480"},
						 @endif	
							 
						 @if($sports_info->video_url_720)	
						 {source:"encrypt:{{base64_encode($sports_info->video_url_720)}}", label:"720"},
						 @endif	
							 
						 @if($sports_info->video_url_1080)	
						 {source:"encrypt:{{base64_encode($sports_info->video_url_1080)}}", label:"1080"}
						 @endif	  
						 @endif
					 ],
					 posterPath:"{{URL::to('/'.$sports_info->video_image)}}",
					 showErrorInfo:"yes",
					 ...
					 subtitlesSource:[						 
						 ...
						 @if($sports_info->subtitle_on_off)
							 ...
							 {subtitlePath:"{{$sports_info->subtitle_url1}}", subtileLabel:"{{$sports_info->subtitle_language1?$sports_info->subtitle_language1:'English'}}"}, 
							 @endif
							 @if($sports_info->subtitle_url2)
							 {subtitlePath:"{{$sports_info->subtitle_url2}}", subtileLabel:"{{$sports_info->subtitle_language2?$sports_info->subtitle_language2:'English'}}"}, 		
							 @endif
							 @if($sports_info->subtitle_url3)
							 {subtitlePath:"{{$sports_info->subtitle_url3}}", subtileLabel:"{{$sports_info->subtitle_language3?$sports_info->subtitle_language3:'English'}}"},							 		
							 @endif    
						 @endif
					 ],
					 //audio visualizer
					 ...
					 @if(get_player_cong('player_default_ads')=="Custom")
					 ...
					 @elseif(get_player_cong('player_default_ads')=="Vast")
