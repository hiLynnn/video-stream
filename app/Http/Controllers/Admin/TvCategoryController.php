...
class TvCategoryController extends MainAdminController
{
    ...
    public function category_list()    { 
        ...
        $page_title=trans('words.live_tv_category');
              
        $category_list = TvCategory::orderBy('category_name')->paginate(10);
         
        return view('admin.pages.livetv_category.list',compact('page_title','category_list'));
    }
    ...
    public function addCategory()    { 
        ...
        return view('admin.pages.livetv_category.addedit',compact('page_title'));
    }
    ...
    { 
        ...
        if(!empty($inputs['id'])){
         ...
         $category_slug = Str::slug($inputs['category_name'], '-',null);
    ...
    {     
          ...
          return view('admin.pages.livetv_category.addedit',compact('page_title','cat_info'));
